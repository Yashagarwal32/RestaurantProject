  ...
  function fun(){
    ...
    elems[i].disabled = true;
	  ...
	  var elements = document.getElementsByTagName("input");
		...
		document.getElementById("demo").innerHTML="<table class='table'><tr><td><b>S.No.  </td><td>Product </td><td>Price </td><td>Quantity </td> <td>Total Price</td></tr><b><br>"
	for (var i = 0; i < elements.length; i++) 
	{
    if (elements[i].value >0 ){
		
		count++;
		document.getElementById("demo").innerHTML+="<tr><td>"+count+"</td>";
		...
		{
		   var z=x[j].innerHTML;
		   document.getElementById("demo").innerHTML+="<td>"+z+"</td> ";
		}
			document.getElementById("demo").innerHTML+=" <td>"+elements[i].value+"</td>";
		...
		tp=oneff*twof;
		amount+=tp;
		document.getElementById("demo").innerHTML+="<td>"+tp+"</td></tr>";
